...
CREATE TABLE `anamnese` (
  ...
  `probl_saude` double DEFAULT NULL,
  `probl_saude_quais` varchar(50) DEFAULT NULL,
  `toma_medicamentos` double DEFAULT NULL,
  `toma_medic_quais` varchar(50) DEFAULT NULL,
  `gravida` double DEFAULT NULL,
  `anestesia` double DEFAULT NULL,
  `sentiu_mal` double DEFAULT NULL,
  `alergico_medicamentos` double DEFAULT NULL,
  `alergico_medicamentos_quais` varchar(50) DEFAULT NULL,
  `perdido_peso` double DEFAULT NULL,
  `diabetis` double DEFAULT NULL,
  `problemas_coracao` double DEFAULT NULL,
  `problema_coracao__quais` varchar(50) DEFAULT NULL,
  `reumatica` double DEFAULT NULL,
  `sangra_muito` double DEFAULT NULL,
  `hepatite` double DEFAULT NULL,
  `cirugia` double DEFAULT NULL,
  `cirugia_quais` varchar(50) DEFAULT NULL,
  `gengiva_sangram` double DEFAULT NULL,
  `mobilidade_dentes` double DEFAULT NULL,
  `mobildade_quais` varchar(50) DEFAULT NULL,
  `escova_dentes` varchar(15) DEFAULT NULL,
  `fio_dental` double DEFAULT NULL,
...
(1,1,'coceira sarna',1,'vitamina',1,1,1,1,'nenhum',1,1,1,'paixao',NULL,NULL,NULL,1,'cirurgia',1,NULL,NULL,'3',1,'2024-10-08 17:55:58',NULL,NULL,'1',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'sdfsdfsdf',180,'2025-04-06 03:00:00');
...
(2,'Energia Eletrica','D','A','2024-10-17 15:34:55','2024-10-17 15:34:55');
...
(1,'PARTICULAR','01','Não','2024-10-02 13:01:56','2024-10-02 13:01:56');
...
CREATE TABLE `forma_pagto` (
  ...
  `lanca_quitacao` varchar(1) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
INSERT INTO `forma_pagto` VALUES
(1,'Pix','S','2024-10-25 13:46:10','2024-10-25 13:46:10'),
(2,'Cartao Crédito','S','2024-10-25 14:31:26','2024-10-25 14:31:26');
...
(1,'NOVALGINA','1 FR','30 GOTAS SE DOR','2024-10-25 19:04:46','2024-10-25 19:04:46');
...
--
-- Table structure for table `movimento_financeiro`
--

DROP TABLE IF EXISTS `movimento_financeiro`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `movimento_financeiro` (
  ...
  `tipo` varchar(1) NOT NULL,
  `cliente_fornecedor` int(11) NOT NULL,
  ...
  `repetir_tipo` varchar(15) DEFAULT NULL,
  `repetir_valor` int(11) DEFAULT NULL,
  PRIMARY KEY (`movimento_id`),
  KEY `movimento_financeiro_contas_FK` (`conta_id`),
  KEY `movimento_financeiro_pacientes_FK` (`cliente_fornecedor`),
  KEY `movimento_financeiro_movimento_financeiro_FK` (`forma_pagto`),
  CONSTRAINT `movimento_financeiro_contas_FK` FOREIGN KEY (`conta_id`) REFERENCES `contas` (`conta_id`),
  CONSTRAINT `movimento_financeiro_movimento_financeiro_FK` FOREIGN KEY (`forma_pagto`) REFERENCES `movimento_financeiro` (`movimento_id`),
  CONSTRAINT `movimento_financeiro_pacientes_FK` FOREIGN KEY (`cliente_fornecedor`) REFERENCES `pacientes` (`codigo`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `movimento_financeiro`
--

LOCK TABLES `movimento_financeiro` WRITE;
/*!40000 ALTER TABLE `movimento_financeiro` DISABLE KEYS */;
INSERT INTO `movimento_financeiro` VALUES
(2,'2024-10-26','R',1,'2024-10-26',NULL,170,NULL,'P',NULL,2,'2024-10-26 11:36:47','2024-10-26 11:36:47',2,NULL,NULL),
(3,'2024-10-28','D',1,'2024-10-30',NULL,150,NULL,'P',NULL,2,'2024-10-28 16:00:08','2024-10-28 16:00:08',2,NULL,NULL),
(4,'2024-10-28','D',1,'2024-10-30',NULL,150,NULL,'P',NULL,2,'2024-10-28 16:20:34','2024-10-28 16:20:34',2,NULL,NULL);
/*!40000 ALTER TABLE `movimento_financeiro` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `orcamento` (
  ...
  `forma_pagto` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `orcamento_forma_pagto_FK` (`forma_pagto`),
  CONSTRAINT `orcamento_forma_pagto_FK` FOREIGN KEY (`forma_pagto`) REFERENCES `forma_pagto` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(1,'2024-10-18','MARIA ANGELICA FERREIRA','R ISMAEL 45','ABADIA','38081537','UBERABA','MG','100.559.203-90','123456','vivi@gmail.com','(49) 9965-5525','residencial','(34)91545-6598','residencial','(34)97856-0202','residencial',540,1,3,'2024-11-01 03:00:00',180,'2024-12-01 03:00:00',180,'2024-12-31 03:00:00',180,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,10,'teste de x','2024-10-18 15:03:05','2024-10-18 15:03:05',600,'2024-11-01','DR CRISTIANO',NULL);
...
(1,'LUCILTON VIEIRA FARIA','1969-10-18',NULL,'ANALISTA DE SISTEMAS','C','863.715.256-20',NULL,NULL,NULL,NULL,NULL,'RUA ELIAS MIGUEL ÁRABE 540','JARDIM DO LAGO','UBERABA','MG','38081-537',NULL,NULL,'(34) 99136-3072','RUA SÃO BENEDITO','SÃO BENEDITO','UBERABA','MG','38022-100',NULL,'M','TESTE',NULL,'123456','LUCILTON VIEIRA FARIA','images/IbrfxhpEw5OYkltVS40fHAtOYSlDp04vbta7LmVC.png',NULL,NULL,'lucilton@gmail.com','123456','SSP-MG','MARIA ABADIA VIEIRA FARIA',NULL,NULL,NULL,NULL,NULL,'2024-10-02 13:06:16');
...
(1,'Implate Dentário X','2024-09-27 13:36:26','2024-10-19 12:27:51','IPX',0),
...
(1,'MARIA ANGELICA FERREIRA','1997-10-25',NULL,'614.444.450-57','Rua Ternura 36','Independencia','Uberaba','MG','38081-530','(34) 9913-6307',NULL,'M',NULL,'123456','CBO','fotos/G8pK1m2eOLQtzQ095On1K4N4rNPbuHqe0rfs6iAV.png',NULL,NULL,'vivi@gmail.com','123456','SSP','Joana Ferreira','teste','2024-10-25 16:03:12','2024-10-25 16:03:12');
...
CREATE TABLE `receitas` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `imprime_data` varchar(1) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
(1,'2024-10-25','Joao da Silva',1,'Normal','2024-10-25 19:05:24','2024-10-25 19:05:24',NULL);
...
INSERT INTO `receitas_medicamentos` VALUES
(1,1,'NOVALGINA','1 FR','30 GOTAS SE DOR MAS NAO EXAGERE NA BEBIDA PORQUE ESTA TODOS PENSANDO QUE VOCE E UM ALCOLATRA DE MUITOS ANOS','2024-10-25 19:05:24','2024-10-25 19:05:24');
...
INSERT INTO `servicos_orcamentos` VALUES
(1,1,'Implate Dentário X','18,25','D',2,300,'2024-10-18 15:03:06','2024-10-18 15:03:06');
...
('apJICLlPT63sAaVcyP5Dm17NwFouo6E5QMZqUWNV',1,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/130.0.0.0 Safari/537.36','',1730497508),
('MusI0En5UYPugpTFtx5CUPCxnscSFacAtPNyPN7V',1,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/130.0.0.0 Safari/537.36','',1730471334),
('xPt5Kkesw5GGma7ZqdqD3mwjI9juncp1E5GGqTdr',1,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/130.0.0.0 Safari/537.36','',1730482753);
...
-- Dump completed on 2024-11-01 19:07:12
