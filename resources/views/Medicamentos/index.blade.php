...
<head>
    ...
    <title>TSDoctor - Medicamentos</title>
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-header d-flex align-items-center justify-content-between">
                                            <h5 class="card-title">Medicamentos Cadastrados</h5>
                                            <a href="{{ url('/medicamentos/create') }}" class="btn btn-primary ms-auto">Novo Medicamento</a>
                                        </div>
                                        <div class="card-body">

                                            <!-- Table starts -->
                                            <div class="table-responsive">
                                                <table id="medicamentosGrid" class="table m-0 align-middle">
                                                    <thead>
                                                        <tr>
                                                            <th style="width: 10%;">#</th>
                                                            <th style="width: 30%;">Medicamento</th>
                                                            <th style="width: 20%;">Quant</th>
                                                            <th style="width: 30%;">Posologia</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ $medicamento->quant }}</td>
                                                            <td>{{ $medicamento->posologia }}</td>
                                                            <td>
                                                                <div class="d-inline-flex gap-1">
                                                                    <a href="{{ url('/medicamentos/' . $medicamento->id) }}" class="btn btn-success btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="View">
                                                                        <i class="ri-eye-line"></i>
                                                                    </a>
                                                                    <a href="{{ url('/medicamentos/' . $medicamento->id . '/edit') }}" class="btn btn-outline-success btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit">
                                                                        <i class="ri-edit-line"></i>
                                                                    </a>
                                                                    <form action="{{ url('/medicamentos/' . $medicamento->id) }}" method="POST" class="form-delete">
                                                                        @csrf
                                                                        @method('DELETE')
