                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-header d-flex align-items-center justify-content-between">
                                            ...
                                            <a href="{{ url('/usuarios/create') }}" class="btn btn-primary ms-auto">Novo Usuário</a>
                                        </div>
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table id="usersGrid" class="table m-0 align-middle">
                                                    <thead>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-inline-flex gap-1">
                                                                    <a href="{{ route('users.show', $user->id) }}" class="btn btn-success btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="View">
                                                                        <i class="ri-eye-line"></i>
                                                                    </a>
                                                                    <a href="{{ route('users.edit', $user->id) }}" class="btn btn-outline-success btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit">
