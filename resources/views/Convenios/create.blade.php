                        ...
                        <div class="col-12 mt-4">
                            <div class="card">
                                <div class="card-header d-flex align-items-center justify-content-between">
                                    <h5 class="card-title">Adicionar Convênio</h5>
                                </div>
                                <div class="card-body">
                                    <form action="{{ route('convenios.store') }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="tabela_precos" id="tabela_precos" class="form-control" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="pericia" class="form-label">Perícia</label>
                                            <input type="text" name="pericia" id="pericia" class="form-control" required>
                                        </div>
