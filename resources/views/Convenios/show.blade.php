                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label"><strong>Tabela de Preços:</strong></label>
                                                <p>{{ $convenio->tabela_precos }}</p>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label"><strong>Perícia:</strong></label>
                                                <p>{{ $convenio->pericia }}</p>
                                            </div>
                                            <a href="{{ route('convenios.index') }}" class="btn btn-secondary">Voltar</a>
                                        </div>
