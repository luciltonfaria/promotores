                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-header d-flex align-items-center justify-content-between">
                                            <h5 class="card-title">Convênios Cadastrados</h5>
                                            <a href="{{ url('/convenios/create') }}" class="btn btn-primary ms-auto">Novo Convênio</a>
                                        </div>
                                        <div class="card-body">
                                                    ...
                                                    <tbody>
                                                        @foreach ($convenios as $convenio)
                                                            <tr>
                                                                ...
                                                                <td>{{ $convenio->tabela_precos }}</td>
                                                                <td>{{ $convenio->pericia }}</td>
                                                                <td>
                                                                    <div class="d-inline-flex gap-1">
                                                                        <a href="{{ url('/convenios/' . $convenio->id) }}" class="btn btn-success btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="View">
                                                                            <i class="ri-eye-line"></i>
                                                                        </a>
                                                                        <a href="{{ url('/convenios/' . $convenio->id . '/edit') }}" class="btn btn-outline-success btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit">
                                                                            <i class="ri-edit-line"></i>
                                                                        </a>
                                                                        <form action="{{ url('/convenios/' . $convenio->id) }}" method="POST" class="form-delete">
                                                                            @csrf
                                                                            @method('DELETE')
