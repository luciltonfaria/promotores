...
<head>
    ...
    <title>TSDoctor - Criar Recibo</title>

    <!-- Meta -->
    <meta name="description" content="Criar novo Recibo">
                ...
                <div class="app-body">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Criar Recibo</h5>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="date" id="dt_emissao" name="dt_emissao" class="form-control">
                                        </div>
                                    </div>
                                </div>
