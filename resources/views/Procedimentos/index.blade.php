                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-header d-flex align-items-center justify-content-between">
                                            <h5 class="card-title">Procedimentos Cadastrados</h5>
                                            <a href="{{ url('/procedimentos/create') }}" class="btn btn-primary ms-auto">Novo Procedimento</a>
                                        </div>
                                        <div class="card-body">

                                            <!-- Table starts -->
                                            <div class="table-responsive">
                                                <table id="procedimentosGrid" class="table m-0 align-middle">
                                                    <thead>
                                                        <tr>
                                                            <th style="width: 10%;">#</th>
                                                            <th style="width: 10%;">Código</th>
                                                            <th style="width: 50%;">Procedimento</th>
                                                            <th style="width: 10%;">Vr Referencia</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align='right'>{{ number_format($procedimento->valor_base, 2, ',', '.') }}</td>
                                                            <td>
                                                                <div class="d-inline-flex gap-1">
                                                                    <a href="{{ url('/procedimentos/' . $procedimento->id) }}" class="btn btn-success btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="View">
                                                                        <i class="ri-eye-line"></i>
                                                                    </a>
                                                                    <a href="{{ url('/procedimentos/' . $procedimento->id . '/edit') }}" class="btn btn-outline-success btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit">
                                                                        <i class="ri-edit-line"></i>
                                                                    </a>
                                                                    <form action="{{ url('/procedimentos/' . $procedimento->id) }}" method="POST" class="form-delete">
                                                                        @csrf
                                                                        @method('DELETE')
