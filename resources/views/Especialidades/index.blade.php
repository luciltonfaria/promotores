                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-header d-flex align-items-center justify-content-between">
                                            ...
                                            <a href="{{ route('especialidades.create') }}" class="btn btn-primary ms-auto">Nova Especialidade</a>
                                        </div>
                                        <div class="card-body">

                                            <!-- Table starts -->
                                            <div class="table-responsive">
                                                <table id="especialidadesGrid" class="table m-0 align-middle">
                                                    <thead>
                                                        <tr>
                                                            <th>#</th>
                                                            <th>Especialidade</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>{{ $especialidade->cod_espec }}</td>
                                                            <td>{{ $especialidade->especialidade }}</td>
                                                            <td>
                                                                <div class="d-inline-flex gap-1">
                                                                    <a href="{{ route('especialidades.show', $especialidade->cod_espec) }}" class="btn btn-success btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="View">
                                                                        <i class="ri-eye-line"></i>
                                                                    </a>
                                                                    <a href="{{ route('especialidades.edit', $especialidade->cod_espec) }}" class="btn btn-outline-success btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit">
                                                                        <i class="ri-edit-line"></i>
                                                                    </a>
                                                                    <form action="{{ route('especialidades.destroy', $especialidade->cod_espec) }}" method="POST" class="form-delete">
                                                                        @csrf
                                                                        @method('DELETE')
