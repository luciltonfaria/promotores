<!-- resources/views/forma_pagto/index.blade.php -->
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="col-12 mt-4">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between">
                                    <h5 class="card-title">Formas de Pagamento Cadastradas</h5>
                                    <a href="{{ url('/forma_pagto/create') }}" class="btn btn-primary">Nova Forma de Pagamento</a>
                                </div>
                                <div class="card-body">
                                            ...
                                            <tbody>
                                                @foreach ($formasPagto as $formaPagto)
                                                    <tr>
                                                        ...
                                                        <td>{{ $formaPagto->lanca_quitacao }}</td>
                                                        <td>
                                                            <a href="{{ url('/forma_pagto/' . $formaPagto->id) }}" class="btn btn-success btn-sm">Ver</a>
                                                            <a href="{{ url('/forma_pagto/' . $formaPagto->id . '/edit') }}" class="btn btn-outline-success btn-sm">Editar</a>
                                                            <form action="{{ url('/forma_pagto/' . $formaPagto->id) }}" method="POST" class="d-inline">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="button" class="btn btn-outline-danger btn-sm btn-delete">Excluir</button>
                                                            </form>
                                                        </td>
                                                    </tr>
                                                @endforeach
