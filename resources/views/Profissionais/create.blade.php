...
<head>
    ...
    <title>TSDoctor - Adicionar Profissional</title>
...
<body>
                        ...
                        <div class="col-12 mt-4">
                            <div class="card">
                                <div class="card-header d-flex align-items-center justify-content-between">
                                    <h5 class="card-title">Adicionar Profissional</h5>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="row gx-3">
                                            ...
                                            <div class="col-xxl-9 col-lg-6 col-sm-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="filiacao_mae" id="filiacao_mae" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="date" name="dt_nasc" id="dt_nasc" class="form-control" maxlength="10">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="org_rg" id="org_rg" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="nro_conselho" id="nro_conselho" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="conselho" id="conselho" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="end_resid" id="end_resid" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="bairro_resid" id="bairro_resid" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="cidade_resid" id="cidade_resid" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="telef2_resid" id="telef2_resid" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="telef2_comer" id="telef2_comer" class="form-control">
                                                </div>
                                            </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#telef_resid, #telef2_resid, #telef2_comer').mask('(00) 0000-0000');
            $('#celular').mask('(00) 00000-0000');
            $('#cep_resid').mask('00000-000');
        });
