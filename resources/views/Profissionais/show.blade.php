                        ...
                        <div class="col-12 mt-4">
                            <div class="card">
                                <div class="card-header d-flex align-items-center justify-content-between">
                                    <h5 class="card-title">Detalhes do Profissional</h5>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <p>{{ $profissional->estado_resid }}</p>
                                    </div>
                                    @if ($profissional->foto)
                                    <div class="mb-3">
                                        <label class="form-label"><strong>Foto:</strong></label>
                                        <img src="{{ asset('storage/' . $profissional->foto) }}" alt="Foto do Paciente" class="img-fluid">
                                    </div>
                                    @endif
