...
<head>
    ...
    <title>TSDoctor - Profissionais</title>
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-header d-flex align-items-center justify-content-between">
                                            <h5 class="card-title">Profissionais Cadastrados</h5>
                                            <a href="{{ url('/profissionais/create') }}" class="btn btn-primary ms-auto">Novo Profissional</a>
                                        </div>
                                        <div class="card-body">

                                            <!-- Table starts -->
                                            <div class="table-responsive">
                                                <table id="profissionaisGrid" class="table m-0 align-middle">
                                                    <thead>
                                                        <tr>
                                                            <th>#</th>
                                                            <th>Nome</th>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-inline-flex gap-1">
                                                                    <a href="{{ url('/profissionais/' . $profissional->codigo) }}" class="btn btn-success btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="View">
                                                                        <i class="ri-eye-line"></i>
                                                                    </a>
                                                                    <a href="{{ url('/profissionais/' . $profissional->codigo . '/edit') }}" class="btn btn-outline-success btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit">
                                                                        <i class="ri-edit-line"></i>
                                                                    </a>
                                                                    <form action="{{ url('/profissionais/' . $profissional->codigo) }}" method="POST" class="form-delete">
                                                                        @csrf
                                                                        @method('DELETE')
